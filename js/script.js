...
function addDay() {
    ...
    days.forEach(day => {
        ...
        dayDiv.innerHTML = `
            ...
            <div class="acciones">
                <img src="./img/03config_disponibilidad/plus0.svg" alt="Add Interval" class="plus" onclick="addInterval('${day}')">
                <img src="./img/03config_disponibilidad/copy0.svg" alt="Duplicate Day" class="copy" onclick="openDuplicateModal('${day}')">
            </div>
        `;
...
document.getElementById('horario-form').addEventListener('submit', function(event) {
    ...
    fetch('guardar_horario.php', {
        ...
        if (response.ok) {
            window.location.href = 'config_servicios.php';
        } else {
